...
const users = [ 
 ...
 function printNameAndPhones(info){
...
function takeATicketNumber(number){ 
  number.push(++ticketNum)
...
function ticketNumberGeneratorFunc(){
  let ticketNumber = 0;
   return function takeATicketNumber(number){ 
    number.push(++ticketNumber)
