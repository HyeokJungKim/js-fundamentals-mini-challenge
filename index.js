...
function updateGrade(student, mark){
  student.grade=mark
}
...
// => { name: "Duane", grade: 92 }
// Note to grader: I did not assign the 2nd parameter to "grade", since that was the key for the object.
console.log("%c----------", "color: red")
...
function printNameAndPhones(array){
  array.forEach(function(arrayValue,index){
    ...
    console.log(`Cell: ` + arrayValue.phones.cell)
    console.log(`Office: ` + arrayValue.phones.office)
  });
}
